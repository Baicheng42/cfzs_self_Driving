...
class yolov5_detector(object):
    def __init__(self):
        # PLUGIN_LIBRARY = "yolov5_detector/build/libmyplugins.so"
        PLUGIN_LIBRARY = "/home/cfzs/000finnal/xunji/yolov5_detector/build/libmyplugins.so"
        ctypes.CDLL(PLUGIN_LIBRARY)
        # engine_file_path = "yolov5_detector/build/yolov5s.engine"
        engine_file_path = "/home/cfzs/000finnal/xunji/yolov5_detector/build/yolov5s.engine"
        # YoLov5TRT instance
        self.yolov5_wrapper = YoLov5TRT(engine_file_path)
        print("start detection!")

    def detect(self, img):
        img, result_boxes, result_scores, result_classid = self.yolov5_wrapper.infer(img)
        # if draw : draw_boxes(img, result_boxes, result_scores, result_classid)
        return result_boxes, result_scores, result_classid
